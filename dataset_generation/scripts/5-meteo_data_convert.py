...
data = pd.read_csv('dataset_generation/temporary_datasets/meteo_data.csv')
...
data.to_csv('dataset_generation/temporary_datasets/meteo_data_proper_date_format.csv', index=False)
