...
archivo_2021 = 'scripts/Bicing_Trips_2021.csv'
archivo_2022 = 'scripts/Bicing_Trips_2022.csv'
archivo_2023 = 'scripts/Bicing_Trips_2023.csv'
...
datos_totales.to_csv('scripts/Bicing_Trips_Total_raw.csv', index=False)